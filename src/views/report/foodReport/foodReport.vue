...
const getData = async () => {
    ...
    try {
        ...
        console.log("CHK THIS OUT1111111",desserts.value);
    } catch (error) {
        new_loader.value = false;
...
const title = ref('Food Report');

const breadcrumbs = ref([
    {
        text: 'Food Report List',
        disabled: true,
        href: '#'
    }
]);
...
const convertToCSV = (data) => {
  ...
  const csvHeader = ['Id', 'Name', 'Category', 'Daily', 'Weekly', 'Monthly'];
