...
import SalesOverview from "../report/report_component/SalesOverview.vue";
import TotalEarning from "../report/report_component/TotalEarning.vue";
import SalesProfit from "../report/report_component/SalesProfit.vue";
import MonthlyEarnings from "../report/report_component/MonthlyEarnings.vue";
import ProductPerformance from "../report/report_component/ProductPerformance.vue";
...
<template >
                        ...
                        <v-col cols="12" sm="6" class="pt-sm-10 pt-5">
                            <div class="d-flex">
                                <img src="@/assets/images/backgrounds/growth.png" height="40"
                                        alt="icon" class="mt-2"/>
                                <div>
                                    <h5 class="text-h3 ml-4  d-block textPrimary">Report</h5>
                                    <h6 class="text-medium-emphasis ms-4 text-subtitle-1 textSecondary">Restaurant Performance</h6>
    ...
    <div class="">
        <v-row  id="test">
            ...
            <v-col cols="12" class="pb-0" v-if="loading !== true">
                
                <h3 class="text-h4">Best Seller</h3>
            </v-col>
            <v-col cols="12" v-if="loading === true" class="p-relative">
                <div  class="loader-container">
                    <div class="loader"></div>
                </div>
            </v-col>
            <template v-else>
                <v-col  cols="12" lg="4" sm="6" v-for="(item) in total" :key="item">
                    <v-card elevation="10">
                        <v-card-item class="px-3">
                            <div class="d-flex align-center" >
                                ...
                                <div class="pl-4">
                                    <!-- <h6 class="text-h6">Best Seller</h6> -->
                                    <h5 class="text-subtitle-1 textSecondary mt-1">{{item.item__dish_name}}</h5>
                                </div>
            ...
            <!-- <v-col cols="12" lg="4" sm="6">
                <v-card elevation="10">
                    <v-card-item class="px-3">
                        <div class="d-flex align-center" >
                            <v-avatar class='rounded-md bg-light success' size="40">
                                <GridDotsIcon size="18" class='text-success' />
                            </v-avatar>
                            <div class="pl-4">
                                <h5 class="text-subtitle-1 textSecondary mt-1">jfdgkfjdgfdg</h5>
                            </div>
                            <v-chip class="ml-auto font-weight-semibold text-subtitle-1 py-5" color="success" rounded="sm" size="small">
                                <GrillIcon />
                            </v-chip>
                        </div>
                    </v-card-item>
