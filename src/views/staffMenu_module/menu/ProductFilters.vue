...
const getAllCat = async () => {
    ...
    try {
        ...
        if (response.data) {
        // Map the API response data to categories array
...
<template>
    <v-sheet class="pa-4">
        ...
        <v-card elevation="0" >
            <v-tabs bg-color="" center-active class="tabCustomSlide"  next-icon="mdi-page-last" prev-icon="mdi-page-first" show-arrows>
                <v-tab><v-checkbox label="All" v-model="selectedCategory" checked class="checkboxStyleCstm" color="light" value="all" hide-details> </v-checkbox></v-tab>
