...
<template>
    <v-row class="justify-center">
        <v-col class="text-center" lg="6">
            ...
            <h5 class="text-h5">You have no any order</h5>
            <v-btn class="mt-3" to="/vlocator/menu/xMqkn87n3NmgK4iPCWFclQRHzahq2ygV/31" variant="flat" color="primary">Go Back to Menu</v-btn>
        </v-col>
    </v-row>
</template>
