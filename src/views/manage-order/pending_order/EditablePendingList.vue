...
import pending_order from '@/_mockApis/apps/manage-order/pending_order';
...
const desserts = ref(pending_order);
    ...
    <v-table class="mt-5">
        ...
        <tbody>
            <tr v-for="item in paginatedList" :key="item.id" :currentPage="currentPage" :pageSize="10">
                ...
                <td>
                    <!-- <span class="text-subtitle-1 d-block mt-1 textSecondary">{{ item.customerType }}</span> -->
