...
<template>
    <v-card elevation="10" >
        <v-card-item>
            <v-card-title class="text-h5">Top Rated Food</v-card-title>
            <v-card-subtitle class="text-subtitle-1 textSecondary">Most Popular</v-card-subtitle>
            <div class="mt-7">
            ...
            <div>
                <div class="d-flex align-center mt-7" v-for="list in weeklyStatsData" :key="list.title">
                    ...
                    <v-chip class="ml-auto font-weight-semibold text-subtitle-1 py-5" :color="list.bgcolor" rounded="sm" size="small">
                        <GrillIcon />
                    </v-chip>
                </div>
            </div>
