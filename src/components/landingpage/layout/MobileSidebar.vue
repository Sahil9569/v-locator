...
<template>
    <div class="pt-6 lp-mobile-sidebar">
        ...
        <v-list class="py-0 px-2 bg-darkTheme">
            <v-list-item rounded="md">
                <v-btn variant="text" class="custom-hover-primary text-white px-0 text-left" flat
                    href="/" >
                    <h5 class="text-subtitle-1">About</h5>
                </v-btn>
            </v-list-item>
            <v-list-item rounded="md">
                <v-btn variant="text" class="custom-hover-primary text-white px-0 text-left" flat
                    href="/" >
                    <h5 class="text-subtitle-1">Contact</h5>
                </v-btn>
            </v-list-item>
