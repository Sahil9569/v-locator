...
<template>
    ...
    <!-- <v-btn variant="text"  class="text-white nav-links" href="/" >About</v-btn> -->
    <router-link to="#" class="text-white nav-links pa-2">
        About
    </router-link>
    <router-link to="#" class="text-white nav-links pa-2">
        Contact us
    ...
    <router-link to="/auth/register">
        <v-btn class="custom-hover-primary bg-primary ml-2 text-white" flat >
