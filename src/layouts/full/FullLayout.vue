...
onMounted(()=>{
    authStore.showLoader = false;
})
</script>

<template>
    <!-----RTL LAYOUT------->
    <div class="logoLoader" v-if="authStore.showLoader==true || authStore.showLoader==null">
        <img src="@/assets/images/locator/logo-light.png" alt="logo-loader"/>
    </div>
            ...
            <v-main>
                <v-container fluid class="page-wrapper pb-sm-15 pb-10">
                    <div :class="customizer.boxed ? 'maxWidth' : ''">
                        <RouterView />
                        <v-btn
                            class="customizer-btn xcvxcvxcvxcvxcv"
                            size="large"
                            icon
                            variant="flat"
                            color="primary"
