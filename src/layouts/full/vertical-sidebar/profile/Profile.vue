...
<template>
    <v-sheet rounded="md" color="lightsecondary" class="px-4 py-3 ExtraBox">
        <div class="d-flex align-center hide-menu">
            <v-avatar size="40">
                <img src="@/assets/images/locator/v-icon.png" alt="user" height="40" />
            </v-avatar>
            <div class="ml-4">
                <h4 class="mb-n1 text-h6 textPrimary">V Locator</h4>
                <span class="text-subtitle-2 textSecondary">Vegan Food</span>
            </div>
            <div class="ml-auto">
